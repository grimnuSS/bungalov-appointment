                ...
                <div class="card">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            <?php
                            $sayi = 0;
                            $yazilar = $db->prepare("SELECT * FROM supports");
                            $yazilar->execute();
                        ...
                        <tr>
                            ...
                            <td><?php echo $yazi['eposta'] ?></td>
                            <td><?php echo $yazi['konu'] ?></td>
                            <td><?php echo $yazi['message'] ?></td>
                            <td><?php echo $yazi['createdAt'] ?></td>
                            <td>
                                <form action="islem.php" method="POST">
                                    <input type="hidden" name="yazi_id" value="<?php echo $yazi['id']; ?>">
                                    <button class="btn btn-danger" name="destek_sil" type="submit">Sil</button>
                                </form>
                            </td>
                        </tr>
                        <?php } ?>
